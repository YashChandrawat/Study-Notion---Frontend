...
const BookAppointmentForm = () => {
  ...
  return (
    <div className="mt-10 px-4 md:px-0 h-screen">
      <h1 className="text-3xl text-white font-semibold text-center">
        Fill below form to contact with our instructor👋
      </h1>
      <form
        className="flex flex-col w-full max-w-lg mx-auto mt-6 p-4 rounded-lg bg-richblack-800 gap-5 text-white"
